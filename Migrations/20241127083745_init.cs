...
namespace API_WEB_Ejercicio3.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Game",
                columns: new[] { "Id", "Description", "GenreId", "Price", "Title" },
                values: new object[,]
                {
                    { 1, "ASJPASJ0", 1, 0.0, "League of Legends" },
                    { 2, "ASJPASJ0", 2, 0.0, "World of Warcraft" },
                    { 3, "ASJPASJ0", 3, 0.0, "Super Mario RPG, The Legend of the Seven Stars" }
                });
